package com.enterprise.taxationapi.web.rest;

import static org.springframework.web.servlet.mvc.method.annotation.SseEmitter.event;

import com.enterprise.taxationapi.config.KafkaSseConsumer;
import com.enterprise.taxationapi.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/taxationapi-kafka")
public class TaxationapiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TaxationapiKafkaResource.class);
    ...
    public TaxationapiKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
