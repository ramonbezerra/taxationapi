...
class CompanyResourceIT {
    ...
    private static final Integer DEFAULT_CNAE = 1;
    private static final Integer UPDATED_CNAE = 2;

    private static final String DEFAULT_PRINCIPAL_ACTIVITY = "AAAAAAAAAA";
    private static final String UPDATED_PRINCIPAL_ACTIVITY = "BBBBBBBBBB";
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company()
            ...
            .cnpj(DEFAULT_CNPJ)
            .cnae(DEFAULT_CNAE)
            .principalActivity(DEFAULT_PRINCIPAL_ACTIVITY);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company()
            ...
            .cnpj(UPDATED_CNPJ)
            .cnae(UPDATED_CNAE)
            .principalActivity(UPDATED_PRINCIPAL_ACTIVITY);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getCnae()).isEqualTo(DEFAULT_CNAE);
        assertThat(testCompany.getPrincipalActivity()).isEqualTo(DEFAULT_PRINCIPAL_ACTIVITY);
    }
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].principalActivity").value(hasItem(DEFAULT_PRINCIPAL_ACTIVITY)));
    }
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.principalActivity").value(DEFAULT_PRINCIPAL_ACTIVITY));
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).cnae(UPDATED_CNAE).principalActivity(UPDATED_PRINCIPAL_ACTIVITY);
        ...
        assertThat(testCompany.getCnae()).isEqualTo(UPDATED_CNAE);
        assertThat(testCompany.getPrincipalActivity()).isEqualTo(UPDATED_PRINCIPAL_ACTIVITY);
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.cnpj(UPDATED_CNPJ).cnae(UPDATED_CNAE);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).cnae(UPDATED_CNAE).principalActivity(UPDATED_PRINCIPAL_ACTIVITY);
